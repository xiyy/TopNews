...
import com.xi.liuliu.topnews.adapter.FolderAdapter;
import com.xi.liuliu.topnews.adapter.ImageAdapter;
...
import com.xi.liuliu.topnews.utils.ImageHelper;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private void confirm() {
        ...
        intent.putStringArrayListExtra("select_images_list", images);
    ...
    private void toPreviewActivity(ArrayList<Image> images, int position) {
        if (images != null && !images.isEmpty()) {
            ImgPreviewActivity.openActivity(this, images,
                    mAdapter.getSelectImages(), position);
        }
    }
...
//            Toast.makeText(this, "没有图片", Toast.LENGTH_LONG).show();
    ...
    private void loadImageForSDCard() {
        ImageHelper.loadImageForSDCard(this, new ImageHelper.DataCallback() {
            @Override
