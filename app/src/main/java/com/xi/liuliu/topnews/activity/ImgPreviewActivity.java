...
import com.xi.liuliu.topnews.adapter.ImagePagerAdapter;
...
public class ImgPreviewActivity extends AppCompatActivity {
    private android.support.v4.view.ViewPager vpImage;
    ...
    public static void openActivity(Activity activity, ArrayList<Image> images, ArrayList<Image> selectImages, int position) {
        tempImages = images;
        tempSelectImages = selectImages;
        Intent intent = new Intent(activity, ImgPreviewActivity.class);
        intent.putExtra("img_position_preview", position);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Bitmap selectBitmap = BitmapFactory.decodeResource(resources, R.drawable.image_selector_image_selected);
        ...
        Bitmap unSelectBitmap = BitmapFactory.decodeResource(resources, R.drawable.image_selector_image_un_selected);
        ...
        vpImage.setCurrentItem(getIntent().getIntExtra("img_position_preview", 0));
    }
